...
Shader "outline"
{
	Properties
	{
		...
		[ASEEnd]_HighlightStrength("HighlightStrength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 bakedGI10 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, ase_worldNormal);
				MixRealtimeAndBakedGI(ase_mainLight, ase_worldNormal, bakedGI10, half4(0,0,0,0));
				float2 uv_MainTex = IN.ase_texcoord5.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 Difuse17 = ( float4( ( temp_output_7_0 + ( ( 1.0 - temp_output_7_0 ) * bakedGI10 ) ) , 0.0 ) * _MainLightColor * ( tex2D( _MainTex, uv_MainTex ) * _Color0 ) );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult21 = normalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult22 = dot( normalizeResult21 , normalizedWorldNormal );
				float temp_output_3_0_g4 = ( pow( dotResult22 , exp2( ( ( 0.0 * 10.0 ) + 1.0 ) ) ) - 0.0 );
				float4 Specular32 = ( saturate( ( temp_output_3_0_g4 / fwidth( temp_output_3_0_g4 ) ) ) * _SpecularColor * 0.0 );
				...
				float4 Highligth51 = ( ( NdotL37 * temp_output_42_0 * _MainLightColor * _HighlightStrength ) + float4( 0,0,0,0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( Difuse17 + Specular32 + Highligth51 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
294;73;1318;653;2986.7;744.4099;2.535372;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1635.056,1194.651;Inherit;False;Property;_HighlightStrength;HighlightStrength;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-2500.753,1205.326;Inherit;False;Property;_FresnelScale;FresnelScale;3;0;Create;True;0;0;0;False;0;False;1;0.18;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;31;-1049.841,314.3469;Inherit;False;Step Antialiasing;-1;;4;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;14;-1199.015,-212.5148;Inherit;True;Property;_MainTex;albedo;0;0;Create;False;0;0;0;False;0;False;-1;None;8930155000f16514bb979b3b0441f9b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;16;-1090.589,9.168686;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-1141.841,484.3468;Inherit;False;Property;_SpecularColor;SpecularColor;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.6981132,0.3921296,0.1020826,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=788DCF804AA510678762A39AC79218353CDBB0EE